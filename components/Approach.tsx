...
export function Approach() {
  ...
  return (
    <section id="approach" className="relative overflow-hidden bg-navy/[0.03] py-16 md:py-24">
      <PitchDiagram className="pointer-events-none absolute inset-0 h-full w-full text-navy/[0.05]" />
